...
import { createReport } from '../../actions/dashboardActions';
...
class ReportCreate extends Component {
    ...
    onSubmit(e) {
        ...
        this.props.createReport(newReport, this.props.history)
...
export default connect(mapStateToProps, { createReport, clearErrors })(withRouter(ReportCreate));
